...
class Config:
    ...
    Chatbot模型参数
    '''
    corpus_data_path = 'chatPlugin/corpus.pth' #已处理的对话数据
    use_QA_first = True #是否载入知识库
    max_input_length = 50 #输入的最大句子长度
    max_generate_length = 20 #生成的最大句子长度
    prefix = 'chatPlugin/checkpoints/chatbot'  #模型断点路径前缀
    model_ckpt  = 'chatPlugin/checkpoints/chatbot_0509_1437' #加载模型路径
    '''
    训练超参数
    '''
    batch_size = 2048
